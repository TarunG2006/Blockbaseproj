...
function App() {
  ...
  const contractAddress = "0x9044b30d0cb8edf6f1daed07755b3f3a482681b0"; // Paste the address recieved from Remix IDE here
      ...
      <header className="App-header">
        ...
        : (
          <div>
            ...
            <div style={{ height:'60px',width:'100%',padding: '10px', backgroundColor:'orange',fontSize:'32px'}}>
